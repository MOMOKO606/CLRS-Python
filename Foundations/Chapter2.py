...
def insertion_sortRecur(A, n):
    """
    Recursive insertion sort Chapter 2.
    Idea: Sort A[0,1,...,n] equals to insert A[n] into the sorted A[0,1,...,n - 1].
    """

    if n > 0:
        insertion_sortRecur(A, n - 1)
        insert(A, n)


def insertion_sortRecur_aux(A):
    """
...
def binary_search_recur_aux(A, x):
    """
...
def exchange(x, y):
    ...
    The Naive algorithm for exchanging the values of x and y.
    """
...
if __name__ == "__main__":
    ...
    5.inversion_naive
      inversion_mergesort_aux
      inversion_mergesort
      inversion_merge

    6.linear_search
      binary_search_iter
      binary_searth_recu_aux
      binary_search_recur
    ...
    print( insertion_sortRecur_aux(A1) )
    print( binary_search_iter(A4, 1) )
    print( binary_search_recur_aux(A4, 1) )
